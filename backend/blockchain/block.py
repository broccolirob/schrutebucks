...
class Block:
    ...
    def mine_block(last_block, data):
        ...
        while hex_to_binary(block_hash)[0:difficulty] != '0' * difficulty:
            nonce += 1
            timestamp = time.time_ns()
            difficulty = Block.adjust_difficulty(last_block, timestamp)
    ...
    def genesis():
        ...
        #     block_hash=GENESIS_DATA['block_hash'],
    ...
    def is_valid_block(last_block, block):
        ...
        if hex_to_binary(block.block_hash)[0:block.difficulty] != '0' * block.difficulty:
        ...
        if block.block_hash != reconstructed_hash:
            raise Exception('The block_hash must be correct')
